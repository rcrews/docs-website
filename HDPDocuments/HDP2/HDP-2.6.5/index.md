...
title: HDP
version: 2.6.5
base-path: /HDPDocuments/HDP2/HDP-2.6.5/
  ...
  - title: Install
    ...
    books:
      - title: Apache Ambari Installation
        url: ../../Ambari-2.6.2.2/bk_ambari-installation/content/ch_Getting_Ready.html
        pdf: ../../Ambari-2.6.2.2/bk_ambari-installation/bk_ambari-installation.pdf

      - title: Apache Ambari Installation for IBM Power Systems
        url: ../../Ambari-2.6.2.2/bk_ambari-installation-ppc/content/ch_Getting_Ready.html
        pdf: ../../Ambari-2.6.2.2/bk_ambari-installation-ppc/bk_ambari-installation-ppc.pdf
  ...
  - title: Upgrade
    ...
    books:
      - title: Apache Ambari Upgrade
        url: ../../Ambari-2.6.2.2/bk_ambari-upgrade/content/ambari_upgrade_guide.html
        pdf: ../../Ambari-2.6.2.2/bk_ambari-upgrade/bk_ambari-upgrade.pdf
    ...
    books:
      - title: Cloud Data Access
        ...
        contents:
          ...
          - chapter: Working with Amazon S3
            url: bk_cloud-data-access/content/s3-get-started.html
          - chapter: Working with ADLS
            url: bk_cloud-data-access/content/adls-get-started.html
          - chapter: Working with WASB
            url: bk_cloud-data-access/content/wasb-get-started.html
          - chapter: Working with Google Cloud Storage (Technical Preview)
            url: bk_cloud-data-access/content/gcp-get-started.html
