...
title: HDP
version: 1.3.1
base-path: /HDPDocuments/HDP1/HDP-1.3.1/
  ...
  - title: Release Notes
    ...
    books:
      - title: Release Notes
        ...
        pdf: bk_releasenotes_hdp_1.x/bk_releasenotes_hdp_1.x-20130612.pdf
  ...
  - title: Install
    ...
    books:
      ...
      - title: Installing HDP Manually
        ...
        pdf: bk_installing_manually_book/bk_installing_manually_book-20130612.pdf
  ...
  - title: Using
    ...
    books:
      - title: Data Integration Services with HDP
        ...
        pdf: bk_dataintegration/bk_dataintegration-20130612.pdf
      ...
      - title: User Guides
        ...
        pdf: bk_user-guide/bk_user-guide-20130612.pdf

      - title: System Administration Guides
        url: bk_hdp1-system-admin-guide/content/index.html
        pdf: bk_hdp1-system-admin-guide/bk_hdp1-system-admin-guide-20130612.pdf

      - title: Administering Hadoop with Ambari Web	
        url: bk_Monitoring_Hadoop_Book/content/index.html
        pdf: bk_Monitoring_Hadoop_Book/bk_Monitoring_Hadoop_Book-20130612.pdf

      - title: Reference
        url: bk_reference/content/index.html
        pdf: bk_reference/bk_reference-20130612.pdf
