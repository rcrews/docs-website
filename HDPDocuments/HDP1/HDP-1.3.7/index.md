...
title: HDP
version: 1.3.7
base-path: /HDPDocuments/HDP1/HDP-1.3.7/
  ...
  - title: Release Notes
    ...
    books:
      - title: Release Notes
        ...
        pdf: bk_releasenotes_hdp_1.x/bk_releasenotes_hdp_1.x-20140425.pdf
  ...
  - title: Install
    ...
    books:
      - title: Getting Started
        ...
        pdf: bk_getting-started-guide/bk_getting-started-guide-20140425.pdf

      - title: Cluster Planning
        url: bk_cluster-planning-guide/content/index.html
        pdf: bk_cluster-planning-guide/bk_cluster-planning-guide-20140425.pdf

      - title: Installing HDP Manually
        url: bk_installing_manually_book/content/index.html
        pdf: bk_installing_manually_book/bk_installing_manually_book-20140425.pdf

      - title: Installing Hadoop Using Apache Ambari
        url: bk_using_Ambari_book/content/index.html
        pdf: bk_using_Ambari_book/bk_using_Ambari_book-20140425.pdf
  ...
  - title: Using
    ...
    books:
      - title: Data Integration Services with HDP
        ...
        pdf: bk_dataintegration/bk_dataintegration-20140425.pdf

      - title: Using WebHDFS REST API
        url: bk_webhdfs/content/index.html
        pdf: bk_webhdfs/bk_webhdfs-20140425.pdf

      - title: User Guides
        url: bk_user-guide/content/index.html
        pdf: bk_user-guide/bk_user-guide-20140425.pdf

      - title: System Administration Guides
        url: bk_hdp1-system-admin-guide/content/index.html
        pdf: bk_hdp1-system-admin-guide/bk_hdp1-system-admin-guide-20140425.pdf

      - title: Administering Hadoop with Ambari Web	
        url: bk_Monitoring_Hadoop_Book/content/index.html
        pdf: bk_Monitoring_Hadoop_Book/bk_Monitoring_Hadoop_Book-20140425.pdf
